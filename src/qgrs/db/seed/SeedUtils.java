...
public class SeedUtils {
	...
	public static final String [] ComparisonSpeciesSet = {"Mus musculus", "Drosophila melanogaster"};
			/*{"Pan troglodytes", "Canis lupus familiaris", "Danio rerio",  "Caenorhabditis elegans", "Kluyveromyces lactis"};//, "Bos taurus"};
	*/
